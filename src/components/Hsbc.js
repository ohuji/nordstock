...
class Hsbc extends Component {
    ...
    getChartData = () => {
       ...
       fetch("https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=LON:HSBA&apikey=WF9H64N6MXWBW9AJ")
       .then(response => {
      ...
      const { Xaxis, Yaxis } = this.state
        return(
         ...
         <div className="container-fluid leftAnimation">
           <h1 className="mt-5 mb-4">HSBC Osake (LON: HSBA)</h1>
            <div className="row">       
         ...
         <div className="offset-md-1">  
          ...
          <ul className="list-group list-group-flush mt-5">
            ...
            <li className="list-group-item">
              <h6>Markkina arvo:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 82 miljardia (USD)</h6>
            </li>
          </ul>
         </div>
        </div>  
