...
class Litecoin extends Component {
    ...
    getChartData = () => {
       ...
       fetch("https://www.alphavantage.co/query?function=DIGITAL_CURRENCY_DAILY&symbol=LTC&market=EUR&apikey=WF9H64N6MXWBW9AJ")
       .then(response => {
        ...
        return(
         ...
         <div className="offset-md-1">  
          ...
          <ul className="list-group list-group-flush mt-5">
            ...
            <li className="list-group-item">
              <h6>Lyhenne/Symboli:&nbsp;&nbsp;&nbsp;&nbsp; LTC</h6>
            </li>

            <li className="list-group-item">
              <h6>Julkaisuvuosi:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2011</h6>
            </li>
