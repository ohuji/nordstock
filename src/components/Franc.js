...
class Franc extends Component {
    ...
    getChartData = () => {
       ...
       fetch("https://www.alphavantage.co/query?function=FX_DAILY&from_symbol=CHF&to_symbol=EUR&apikey=WF9H64N6MXWBW9AJ")
       .then(response => {
      ...
      const { Xaxis, Yaxis } = this.state
        return(
         ...
         <div className="container-fluid leftAnimation">
           <h1 className="mt-5 mb-4">Swiss Franc (CHF)</h1>
            <div className="row">       
