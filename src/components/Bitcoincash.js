...
class Bitcoincash extends Component {
    ...
    getChartData = () => {
       ...
       fetch("https://www.alphavantage.co/query?function=DIGITAL_CURRENCY_DAILY&symbol=BCH&market=EUR&apikey=WF9H64N6MXWBW9AJ")
       .then(response => {
      ...
      const { Xaxis, Yaxis } = this.state
        return(
         ...
         <div className="container-fluid">
           <h1 className="mt-5 mb-4">Bitcoin Cash (BCH)</h1>
            <div className="row">       
         ...
         <div className="offset-md-1">  
          ...
          <ul className="list-group list-group-flush mt-5">
            ...
            <li className="list-group-item">
              <h6>Nimi:&nbsp;&nbsp; Bitcoin Cash</h6>
            </li>

            <li className="list-group-item">
              <h6>Lyhenne/Symboli:&nbsp;&nbsp;&nbsp;&nbsp; BCH</h6>
            </li>

            <li className="list-group-item">
              <h6>Julkaisuvuosi:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2017</h6>
            </li>
