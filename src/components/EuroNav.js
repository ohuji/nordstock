...
class EuroNav extends Component {
    state = {
        currencyData: []
    }
    ...
    getData = () => {   
        ...
        fetch("https://www.alphavantage.co/query?function=FX_DAILY&from_symbol=EUR&to_symbol=USD&apikey=WF9H64N6MXWBW9AJ")
        .then(response => {
        ...
        if (currencyData[0] > currencyData[1]) {
            ...
            return(
                <div className="list-group-item NavList">
                    <Link className="NavLink" to="/Currencies/EUR">
                        <h5 className="linkSize">European Euro</h5>
                    </Link>
