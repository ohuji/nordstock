...
class Amd extends Component {
    ...
    getChartData = () => {
       ...
       fetch("https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=AMD&apikey=WF9H64N6MXWBW9AJ")
       .then(response => {
        ...
        return(
         ...
         <div className="offset-md-1">  
          ...
          <ul className="list-group list-group-flush mt-5">
            ...
            <li className="list-group-item">
              <h6>Nimi:&nbsp;&nbsp; Advanced Micro Devices</h6>
            </li>
            ...
            <li className="list-group-item">
              <h6>Markkina arvo:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 65 miljardia (USD)</h6>
            </li>
          </ul>
         </div>
        </div>  
