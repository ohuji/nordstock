...
class Oracle extends Component {
    ...
    getChartData = () => {
       ...
       fetch("https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=ORCL&apikey=WF9H64N6MXWBW9AJ")
       .then(response => {
      ...
      const { Xaxis, Yaxis } = this.state
        return(
         ...
         <div className="container-fluid">
           <h1 className="mt-5 mb-4">Oracle osake (NYSE: ORCL)</h1>
            <div className="row">       
