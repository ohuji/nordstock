...
class Linde extends Component {
    ...
    getChartData = () => {
       ...
       fetch("https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=FRA:LIN&apikey=WF9H64N6MXWBW9AJ")
       .then(response => {
      ...
      const { Xaxis, Yaxis } = this.state
        return(
         ...
         <div className="container-fluid leftAnimation">
           <h1 className="mt-5 mb-4">Linde Osake (FRA: LIN)</h1>
            <div className="row">       
         ...
         <div className="offset-md-1">  
          ...
          <ul className="list-group list-group-flush mt-5">
            ...
            <li className="list-group-item">
              <h6>Markkina arvo:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 88 miljardia (EUR)</h6>
            </li>
          </ul>
         </div>
        </div>  
