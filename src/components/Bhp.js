      ...
      const { Xaxis, Yaxis } = this.state
        return(
         ...
         <div className="container-fluid leftAnimation">
           <h1 className="mt-5 mb-4">BHP Group osake (ASX: BHP)</h1>
            <div className="row">       
         ...
         <div className="offset-md-1">  
          ...
          <h2 className="text-success">AU${Yaxis[0]}</h2>
          ...
          <ul className="list-group list-group-flush mt-5">
            ...
            <li className="list-group-item">
              <h6>Nimi:&nbsp;&nbsp;&nbsp;&nbsp; BHP Group Ltd</h6>
            </li>
            <li className="list-group-item">
              <h6>Lyhenne:&nbsp;&nbsp;&nbsp;&nbsp; BHP</h6>
            </li>
            <li className="list-group-item">
              <h6>Pörssi:&nbsp;&nbsp;&nbsp;&nbsp; Australian Stock Exhange</h6>
            </li>
            <li className="list-group-item">
              <h6>Markkina arvo:&nbsp;&nbsp;&nbsp;&nbsp; 196 miljardia (USD)</h6>
            </li>
          </ul>
         </div>
        </div>  
